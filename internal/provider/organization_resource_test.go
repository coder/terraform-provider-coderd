...
func TestAccOrganizationResource(t *testing.T) {
	...
	cfg1 := testAccOrganizationResourceConfig{
		...
		Name:        PtrTo("example-org"),
		DisplayName: PtrTo("Example Organization"),
		Description: PtrTo("This is an example organization"),
		Icon:        PtrTo("https://google.com"),
		Members:     PtrTo([]string{user1.ID.String()}),
	}

	cfg2 := cfg1
	cfg2.Name = PtrTo("example-org-new")
	cfg2.DisplayName = PtrTo("Example Organization New")
			...
			Steps: []resource.TestStep{
				// Create and Read
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("coderd_organization.test", "icon", "https://google.com"),
